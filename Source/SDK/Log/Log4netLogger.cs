...
namespace Expressly.Log
{
    ...
    internal class Log4netLogger : BaseLogger
    {
        ...
        private static Type expresslyLogLogger;
        ...
        private static void Reflect()
        {
            lock (Log4netLogger.syncLock)
            {
                ...
                try
                {
                    expresslyLogLogger = Type.GetType("Expressly.Log.Logger");
                    ...
                    if (LogConfiguration.LoggerListInConfiguration.Contains("Expressly.Log.Log4netLogger"))
                    {
