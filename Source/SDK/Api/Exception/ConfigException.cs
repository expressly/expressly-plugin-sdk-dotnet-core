...
{
    /// <summary>
    /// Represents an error that occurred in the Expressly SDK when attempting to load information from the application's config file.
    /// </summary>
    public class ConfigException : ExpresslyException
    {
		/// <summary>
