...
{
    /// <summary>
    /// Represents an error that occurred in the Expressly SDK.
    /// </summary>
    public class ExpresslyException : System.Exception
    {
        /// <summary>
        /// Logs output statements, errors, debug info to a text file    
        /// </summary>
        private static Logger logger = Logger.GetLogger(typeof(ExpresslyException));

        /// <summary>
        /// Initializes a new <seealso cref="ExpresslyException"/> with no exception details set.
        /// </summary>
        public ExpresslyException() : this(string.Empty) { }
        
        /// <summary>
        /// Represents errors that occur during application execution
        /// </summary>
        /// <param name="message">The message that describes the error</param>
        public ExpresslyException(string message): this(message, null) { }

        /// <summary>
        /// Initializes a new <seealso cref="ExpresslyException"/> and sets the exception message and cause.
        /// </summary>
        /// <param name="message">The message that describes the error</param>
        /// <param name="cause">The exception that is the cause of the current exception</param>
        public ExpresslyException(string message, System.Exception cause) : base(message, cause)
        {
        ...
        protected ExpresslyException(ExpresslyException ex) : base(ex.Message, ex.InnerException) { }
